...
Select the [Scripted AI Agent](./downloads/OrderingBot.zip) to download the AI Agent to your desktop. 

In AI Agent Studio, select the *Import agent* button at the top, right side of the studio.

**FILL IN REST OF DIRECTIONS**
...
Repeat this for the user_pin entity. The response name you need to find is "PIN missing". Reference the image below for the completed Slot filling section.
